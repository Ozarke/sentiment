...
//           with small edit from Ozark 6103116
var ChangeTokenImg = ChangeTokenImg || (function () {
    'use strict';
    var version = '0.1.33',
            lastUpdate = 1509570496,
            observers = {
                tokenChange: []
            },
            ...
            handleInput = function (msg_orig) {
                var msg = (msg_orig),
                        args, cmds, allSides = [], nextSide, nextURL, flipimg, setimg, incrementimg, sameimages, setval, token_id;
                flipimg = false;
                setimg = false;
                sameimages = false;
                incrementimg = false;
